...
const forms: {
    [key: string]: (type: "create" | "update", data?: any, setOpen: Dispatch<SetStateAction<boolean>>, relatedData? : any) => JSX.Element;
} = {
...
const FormModal = ({
    ...
    const bgColor = type === "create" ? "bg-Yellow" : "bg-Purple";
    ...
    const Form = () => {
        ...
        return type === "delete" && id ? (
            <form action="" className="p-4 flex flex-col gap-4">
                ...
                <button className="bg-red-700 text-wgite py-2 px-4 rounded-md border-none w-max self-center">
                    Delete
                </button>
        ...
        <>
...

            {
                open && <div className="w-screen h-screen absolute left-0 top-0 bg-black bg-opacity-60 z-50 flex items-center justify-center">
                    <div className="bg-white p-4 rounded-md relative w-[70%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%]">
                        <Form />
